  ...
  reground: {
    ...
    images: [
      ...
      "/images/branding/reground/reground-05.jpg",
              ...
              unboxed: {
                title: "Unboxed",
                description: "Inspired by the 1929 silent film Pandora's Box, this project explores the ways women are seen, judged, and redefined through visual storytelling. Reinterpreting the film's themes of perception, blame, and resilience, I created three photographic reels titled The Gaze, The Blame, and The Hope, each capturing a distinct emotional lens. Presented through a vintage View-Master, the work invites viewers to engage closely with each image, mirroring the act of looking and being looked at. This device operates on the identical design principles as modern VR headsets, as it uses stereoscopy to create a realistic 3D sense to eliminate outside distractions. Every photograph was taken and curated by me to convey layered meanings through composition, lighting, and symbolism. The piece examines how women have been both confined by and resistant to societal narratives, offering moments of vulnerability, reflection, and empowerment. This artwork will be exhibited at the NYU Library from October to December 2025, inviting audiences to reconsider how the female image continues to evolve within art and culture.",
    category: "Visuals",
